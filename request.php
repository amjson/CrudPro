    ...
    <section>
      ...
      <div class="formPage">
        <nav class="navbar navbar-expand-lg max-width">
          <div class="section_logo">
            <div class="section_logo-big"> 
              <h1 class="blur"><a href="index.html">CrudPro</a></h1>

              <h3 class="focused">
                <a href="index.html">
                  <span class="section_logo-small">Crud<strong>Pro</strong></span>
                </a>
              </h3>
            </div>
          </div> 
          ...
          <ul class="dropMenu">
            <li class='nav-item dropdown caret'>
              ...
              aria-labelledby='navbarDropdownProfile'>
                ...
                <a class='dropdown-item locate' href='index.php'>Signin</a>
              </div>
            </li>
          </ul>
        </nav>
        ...
        <form action="" method="POST" autocomplete="off">             
          <div class="job_body">
            <div class="title"><h4>Forgot Password</h4></div>

            <div class="plainText">
              <p>
                Kindly use the Email that you are using in this App because the Link will be send 
                to you through the Email that you are using in this App
              </p>
            </div>
            ...
            <div class="finalise">
              <input type="submit" class="form-control submit" name="request" value="request">
            </div>
          </div>
        </form>
      </div>
